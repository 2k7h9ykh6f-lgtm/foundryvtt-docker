...
|`felddy/foundryvtt:12.343.0`| An exact image version. |
|`felddy/foundryvtt:12.343`| The most recent image matching the major and minor version numbers. |
...
| `FOUNDRY_VERSION` | Version of Foundry Virtual Tabletop to install. | `12.343` |
...
```console
docker build \
  --build-arg VERSION=12.343.0 \
  --tag felddy/foundryvtt:12.343.0 \
